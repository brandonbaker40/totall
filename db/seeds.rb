...
account = Account.create(name: 'Checking', category: Category.find(3), active: true, note: nil)
...
account = Account.create(name: 'Savings', category: Category.find(3), active: true, note: nil)
...
account = Account.create(name: 'Roth IRA', category: Category.find(5), active: true, note: nil)
...
account = Account.create(name: '401k', category: Category.find(5), active: true, note: nil)
...
account = Account.create(name: 'Stock', category: Category.find(4), active: true, note: nil)
...
account = Account.create(name: '529', category: Category.find(4), active: true, note: 'Billy')
...
account = Account.create(name: 'Old Savings', category: Category.find(3), active: false, note: 'Old Chase account')
...
account = Account.create(name: 'Car', category: Category.find(2), active: true, note: 'Acura')
...
account = Account.create(name: 'Mortgage', category: Category.find(1), active: true, note: '')
